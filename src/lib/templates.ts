...
const TEMPLATE_VARIABLES: Record<Locale, TemplateVariableOption[]> = {
  zh: [
    ...
    { key: 'prof_college', label: '老师学院', example: '{{prof_college}}' },
  ...
  en: [
    ...
    { key: 'prof_college', label: 'Professor college', example: '{{prof_college}}' },
...
export function buildTemplateVariables(
  ...
  return {
    ...
    prof_college: context.professor?.college || (isZh ? '[老师学院]' : '[Professor College]'),
